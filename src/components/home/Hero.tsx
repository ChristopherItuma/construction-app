  ...
  return (
    <main>
      ...
      <section className=" py-3 px-5 lg:px-[5%] bg-bgmix">
          ...
          <AnimatePresence>
            <div className="flex">
              <motion.div
                ...
                className="h-24 w-24 bg-secondary rounded-full shadow-md translate-x-10"
              ></motion.div>
        ...
        <Tabs
          defaultValue="general-construction-services"
          className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 pb-10 pb-35"
        >
          {/* Tabs List */}
          <div className="mb-32 md:mb-0 col-span-2 md:col-span-1 w-full mx-auto flex justify-center items-center md:block">
            <TabsList className="grid grid-cols-2 lg:grid-cols-3 gap-4 pb-10">
              <TabsTrigger value="general-construction-services">
                General Construction
              </TabsTrigger>
              <TabsTrigger value="concrete-work">Concrete Work</TabsTrigger>
              <TabsTrigger value="design-and-planning">
                Design and Planning
              </TabsTrigger>
          ...
          <div className="text-center md:text-left col-span-2 md:col-span-1 md:border-l-2 md:pl-3 md:border-red-200 md:border-groove">
            <TabsContent value="general-construction-services">
              <p>
                ...
                structural work, and finishing touches. We ensure that every
                aspect of your project is executed with precision and care,
                delivering results that exceed expectations.
              </p>
            </TabsContent>
            <TabsContent value="concrete-work">
              <p>
                Our concrete work services include everything from foundations
                to decorative finishes. We use high-quality materials and
                advanced techniques to ensure durability and aesthetic appeal in
                every project.
              </p>
            </TabsContent>
            <TabsContent value="design-and-planning">
              <p>
                Our design and planning services focus on creating functional
                and aesthetically pleasing spaces. We collaborate closely with
                clients to understand their vision and translate it into
                detailed plans that guide the construction process.
              </p>
            </TabsContent>
            <TabsContent value="civil-works">
              <p>
                ...
                engineering expertise to ensure that all projects are completed
            ...
            <TabsContent value="pre-construction">
              <p>
                ...
                This includes feasibility studies, budgeting, scheduling, and
                risk assessment.
              </p>
            </TabsContent>
      ...
      {/* end of header intro intro*/}

      {/* hero image section */}
      <AnimatePresence>
      <motion.section 
      
      className="py-3 px-5 lg:px-5% bg-secondary flex flex-col md:flex-row md:justify-center gap-8 pb-12 md:pb-2">
        <motion.div 
        initial={{x: 100, opacity: 0.8}}
      whileInView={{ x: 0, opacity: 1 }}
      transition={{ duration: 0.3, ease: "linear", }}
        className="-mt-24 pb-10 basis-2/3">
          <Image src={image.pics} alt="Hero Image" 
           className="w-full h-60 md:h-100 rounded-2xl"
           />
        </motion.div>
        <motion.div 
         initial={{x: -100, opacity: 0.8}}
      ...
      transition={{ duration: 0.4, ease: "linear", }}
        className="basis-1/5 bg-primary -mt-12 md:-mt-24 h-100 rounded-lg w-full md:3/5 text-white px-2 py-5 flex flex-col items-center justify-evenly gap-4">
          <div className="flex flex-col items-center">
            <h2 className="text-4xl font-bold">640+</h2>
            <p className="text-md">Project completed</p>
          </div>
          <div className="flex flex-col items-center">
